...
public class ReportAction extends ActionBase {
    ...
    public void update() throws ServletException, IOException {
         ...
         * @throws IOException
         */
    /*    public void newmessage() throws ServletException, IOException {
            ...
            if (checkToken()) {
                ...
                //入力された日報内容を設定する
                rv.setNewmessage(toLocalDate(getRequestParam(AttributeConst.REP_MESSAGE)));
                rv.setTitle(getRequestParam(AttributeConst.REP_TITLE));
                rv.setContent(getRequestParam(AttributeConst.REP_CONTENT));
        ...
        public void newmessage() throws ServletException, IOException {
            ...
            rv.setNewmessage(getRequestParam(AttributeConst.REP_MESSAGE));
